...
class ElectronicsViewController: UIViewController {
    ...
    private func fetchElectronics() {
        ...
        let request = FakeStoreAPI.GetElectronics()
...
// MARK: - CollectionView
extension ElectronicsViewController: UICollectionViewDelegate {
...
extension ElectronicsViewController: UICollectionViewDataSource {
