...
private func fetchElectronics() {
    ...
    let request = FakeStoreAPI.GetJewelerys()
...
// MARK: - CollectionView
extension JeweleryViewController: UICollectionViewDelegate {
...
extension JeweleryViewController: UICollectionViewDataSource {
